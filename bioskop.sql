...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Okt 2022 pada 10.05
...
INSERT INTO `identity` (`id_identity`, `name`, `nik`, `age`) VALUES
(1, 'Naufal Azmi', '3173042210990004', 21),
(2, 'azky', '3173042210990004', 21),
(3, 'Naufal Azmi', '3173042210990004', 22),
(4, 'siapa', '123', 50);
...
INSERT INTO `transaction` (`id_transaction`, `id_movie`, `id_schedule`, `numb_seat`, `watch_date`) VALUES
(1, NULL, 2, 'B3', '12/21/2021'),
(2, NULL, 2, 'B2', '12/21/2021'),
(3, NULL, 3, 'A1', '07/11/2022'),
(4, NULL, 2, 'E4', '10/13/2022');
...
ALTER TABLE `transaction`
  ...
  ADD KEY `fk_schedule` (`id_schedule`);
...
--
ALTER TABLE `identity`
  MODIFY `id_identity` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
ALTER TABLE `transaction`
  ...
  ADD CONSTRAINT `fk_schedule` FOREIGN KEY (`id_schedule`) REFERENCES `schedule` (`id_schedule`);
COMMIT;
